...
from src.views import get_date_interval, filter_date, filter_card, top_five_transactions, request_currencies, currency_rate
import pytest
import datetime
...
def test_top_five_transactions(sample_transact):
    with patch("src.views.filter_date", return_value=sample_transact):
        assert top_five_transactions("01.01.2023 12:30:00")[0] == {'amount': 300,
 'category': 'Аптека',
